...
void compress_chunk32(struct LoadedChunk *chunk, int *packed_values_used,
                      int max_packed_values, struct PackedValues32 *result) {
...
void decompress_chunk32(struct PackedValues32 *packed_values,
                        int n_packed_values, struct LoadedChunk *chunk) {
...
void compress_chunk16(struct LoadedChunk *chunk, int *packed_values_used,
                      int max_packed_values, struct PackedValues16 *result) {
  int i, j, start_x, start_y, end_x, end_y, count = 0;
  int16_t value;
...
void decompress_chunk16(struct PackedValues16 *packed_values,
                        int n_packed_values, struct LoadedChunk *chunk) {
